...
window.WIKI_CONTENT_IT = Object.freeze({
  ...
  patchNotes: [
    ...
    },
    {
      ...
      notes: [
        ...
        "Ogni raid ha ora una propria identità di equipaggiamento: la Marcia dei Radicati protegge, l’Armata Senza Luce sostiene, la Caccia del Cielo Infranto punta sui critici e l’Ultima Via bilancia. Ogni raid offre un’arma per tipo più tre nuove armature da raid creabili (Leggera, Media, Pesante) con quella identità, e riforgiare un pezzo da raid a un grado superiore ne conserva identità ed effetti aumentandone solo le statistiche. Le ricette delle armi consolidate non sono più offerte, ma le armi già create restano utilizzabili e riforgiabili.",
        ...
        "Armi e armature offrono varianti per Colpo critico e Danno base e varianti incentrate su Attacco e Difesa, distribuite in modo sfalsato perché ogni tier introduca una sola famiglia nuova invece di tutte insieme: le armi da critico arrivano ai tier 1, 3, 5, 7, 9 e 11, le armature Attacco/Difesa ai tier 2, 4, 6, 8, 10 e 12. Ogni tier porta comunque un set completo di equipaggiamento nuovo, con scelte meno numerose e più chiare a ogni passo. Gli accessori da combattimento sono divisi tra Tank, DPS e Supporto o Guaritore.",
        ...
        "Ogni raid ora tiene una classifica Completamenti più veloci con le sue dieci sessioni più rapide, ordinate con tempo e data di ciascuna, mostrata nel pannello Statistiche dell’arena, nella scheda Record del raid e in Opzioni > Obiettivi > Record dei raid. I salvataggi precedenti all’aggiornamento partono dai tempi record che già possedevano.",
        "La Discesa dell’Eco è ora un unico scontro con il Guardiano per ogni giorno UTC, al posto di uno strato da cinque profondità. La vittoria concede +1 Risonanza dell’Eco permanente a ciascuno dei cinque eroi vincitori, fino al Grado 10, e chiude l’Eco fino alle successive 00:00 UTC. Una sconfitta o un abbandono non consuma mai la giornata: le stesse leggi, la stessa formazione nemica e la stessa ricompensa restano disponibili per un altro tentativo.",
        "Ogni giorno UTC estrae tre delle nove leggi giornaliere basate sulle meccaniche — un Ambiente, un Adattamento e un’Opportunità — per 27 combinazioni possibili che la rotazione percorre tutte prima di ripetersi. Le leggi riducono il Mana, fanno costare Salute alle abilità attive, tagliano le cure ricevute, annullano del tutto un tipo di danno oppure espongono i nemici a danni aggiuntivi. Uno scontro già iniziato mantiene le leggi e la formazione nemica con cui è cominciato.",
        "I Piani 71–100 della Torre della Risonanza sono calibrati su otto riscossioni giornaliere di Risonanza al ritmo di un grado al giorno, con obiettivi previsti di Grado 2 / 4 / 6 / 8 rispettivamente ai Piani 71–80 / 81–90 / 91–99 / 100. Restano obiettivi di preparazione della configurazione e non requisiti d’ingresso.",
        ...
        "Aggiunti due obiettivi di Risonanza dell’Eco — uno per la sintonia completa di un eroe e uno per la Risonanza complessiva.",
        "Aggiunto Ogni cammino padroneggiato, un obiettivo endgame per avere contemporaneamente nella formazione un eroe di ogni classe élite — tutte e 22 insieme. Le formazioni che soddisfano già il requisito lo sbloccano al caricamento e rimuovere un eroe non lo revoca mai. Il totale sale a 42 obiettivi per 365 punti.",
        ...
        "Aggiunta una finestra Novità legata alla versione che presenta una volta per salvataggio i principali cambiamenti della 1.09, con un pulsante nelle Impostazioni per riaprirla. Gli argomenti della guida ora sono comprimibili e nomi degli stati e terminologia bilingue sono più uniformi.",
        ...
        "La guida alle missioni è passata da una scheda dedicata all’icona Aiuto nella barra del titolo Missioni, come per Taverna, Negozio, Inventario, Laboratorio e Famigli. Missioni si apre ora su Oggi, Settimana e Migliorie.",
        "I pulsanti dei menu rispondono più rapidamente: misurato su telefono con un salvataggio di fine gioco completo, ogni pulsante dei menu è migliorato: il Laboratorio si apre in circa un terzo del tempo di prima, Missioni e Taverna in circa la metà, e tutte le altre schermate dal 25 al 50% più rapidamente, e le schede di Famigli, Taverna, Negozio e Bestiario cambiano all’istante perché il loro contenuto resta in memoria invece di essere ricostruito a ogni selezione. I resoconti delle spedizioni non creano più una scheda per ogni possibile bottino prima di comparire, e l’adattamento del testo e lo stile dei pulsanti non ripetono il proprio lavoro a ogni schermata.",
        "Riscuoti tutto è circa cinque volte più veloce - riscuotere da tutte le spedizioni ricostruiva la pagina Dungeon 36 volte prima di rispondere e ora si aggiorna una sola volta - e la schermata Eroi si apre subito anche con una rosa numerosa, completando il resto dietro alle prime schede."
      ]
    },
    {
      version: "1.07",
    ...
    },
    {
      ...
      notes: [
        ...
        "Aggiunta la Discesa dell'Eco dopo la 70ª sfida della Torre: uno scontro giornaliero con il Guardiano per cinque eroi, due famigli e PE Legame al posto del normale bottino. Vincere concede +1 Risonanza, mentre nove leggi giornaliere combinano pressione sulla sopravvivenza, adattamento nemico e opportunità di contromossa.",
  ...
  probabilityFacts: [
    ...
    {id:"egg", name:"Un boss idoneo lascia il proprio uovo di famiglio", value:"1% dungeon / 20% raid", detail:"Si applica a ogni uccisione di un boss idoneo di dungeon o raid. Un boss di dungeon con uovo muore circa 70 volte in una notte di farming, quindi la sua probabilità per uccisione è bassa; ogni boss di raid muore al massimo una volta al giorno, quindi la sua è alta. Entrambe le fonti danno all'incirca lo stesso numero di uova al giorno. Le uova di famiglia costano 75–300 Gemme in base al grado: 75 al Grado 3, 125 al Grado 5, 150 al Grado 6, 225 al Grado 9 e 300 al Grado 12."},
    ...
    {id:"accessory", name:"Copia ripetuta di un accessorio da raid", value:"15%", detail:"Finché una copia non viene scoperta o è già in attesa, il tiro aumenta a 15%, 20%, 25%, 30%, 35%, 40%, 45%, 50%, 55%, quindi è garantito alla vittoria 10. In seguito torna al 15%."},
