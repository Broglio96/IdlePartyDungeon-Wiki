/*
 * Contenuti della guida in italiano per Idle Party Dungeon 1.07.
...
window.WIKI_CONTENT_IT = Object.freeze({
  ...
  patchNotes: [
    ...
    },
    {
      ...
      notes: [
        "Aggiunti i famigli da spedizione. Raccogli le uova di sei famiglie, schiudi famigli Comuni, Rari, Epici o Leggendari con probabilità dello 0,5% e 2, 3, 4 o 5 bonus al gruppo, assegna un famiglio a una spedizione e portalo al livello 20 tramite ESP Legame.",
        ...
        "Aggiunta la Discesa dell'Eco dopo il Piano 70 della Torre: avanzate illimitate con cinque eroi attraverso strati di cinque profondità, due famigli, Ancore consolidate ed ESP Legame al posto del normale bottino. Il primo Guardiano idoneo di ogni giorno UTC concede +2 Risonanza, mentre nove leggi giornaliere combinano pressione sulla sopravvivenza, adattamento nemico e opportunità di contromossa.",
    ...
    },
    {
      ...
      notes: [
        ...
        "La progressione dei dungeon è stata ribilanciata in tutti e 12 i gradi. Gli incontri ora procedono a un ritmo più uniforme, mentre ESP, tassi di ritrovamento, forza dei nemici, limiti del gruppo e tempi di creazione seguono una curva a lungo termine più graduale.",
    ...
    },
    {
      ...
      notes: [
        ...
        "Introdotto il combattimento automatico a turni del gruppo, con ordine basato sulla Destrezza, selezione del bersaglio ponderata dalla Minaccia, abilità attive e passive, effetti di stato, feedback dei colpi e penalità in ESP alla morte.",
  ...
  quickstart: [
    {
      ...
      tip: "Un Guardian o Fighter, un Cleric o Bard e danni misti Melee, Ranged e Magic offrono l'inizio più sicuro."
    },
    {
      step: "02",
    ...
    },
    {
      ...
      text: "Gli ESP dei dungeon vengono applicati subito agli eroi sopravvissuti; i materiali restano in attesa nella spedizione finché non li raccogli. Usa quei materiali e le Monete per creare equipaggiamento, poi assegna armi e armature di tipo compatibile.",
    ...
    },
    {
      ...
      text: "Al livello 25 una classe base sceglie una delle due specializzazioni. Al livello 50 la specializzazione viene promossa alla classe élite associata. Il livello élite 50 sblocca l'Ascensione.",
  ...
  mechanics: [
    {
      ...
      bullets: [
        ...
        "Gli ESP sono divisi tra gli eroi vivi. I bottini restano associati al dungeon o al raid finché non vengono raccolti.",
        ...
        "I rapporti registrano tempo trascorso, uccisioni, morti, ESP lordi, ESP persi, ESP netti, quantità degli oggetti e valori orari.",
    ...
    },
    {
      ...
      bullets: [
        ...
        "I registri delle battaglie offline vengono omessi, ma ESP, morti, avanzamento degli obiettivi e bottini vengono calcolati.",
    ...
    },
    {
      ...
      summary: "Un eroe sconfitto perde il 10% degli ESP già ottenuti verso il livello corrente. Se cade tutto il gruppo, la spedizione ricrea le entità degli eroi e avvia automaticamente un altro incontro.",
      bullets: [
        "Solo gli eroi vivi condividono gli ESP di un mostro sconfitto.",
    ...
    },
    {
      id: "mist",
      eyebrow: "Ambiente",
      title: "La Nebbia amplifica gli attacchi invece di infliggere danni automatici",
      summary: "La Nebbia effettiva è la percentuale di Nebbia attuale del dungeon ridotta dalla Riduzione Nebbia del bersaglio. Il Danno da Nebbia dell'attaccante scala poi il danno in base a quel valore effettivo.",
      bullets: [
        ...
        "La Riduzione Nebbia non può portare la Nebbia effettiva sotto lo 0%.",
        "I dungeon avanzati possono iniziare con la Nebbia e modificarla periodicamente; la pagina di dettaglio di ogni dungeon elenca le impostazioni attuali.",
    ...
    },
    {
      ...
      summary: "I cataloghi nel gioco nascondono intenzionalmente i contenuti non ancora incontrati, ma questo Codex presenta l'intero sistema di regole della 1.07 come riferimento strategico completo.",
      bullets: [
  ...
  formulas: [
    {
      name: "Salute massima",
      formula: "(PS base + 10 × (livello carriera − 1) + 5 × Forza + PS piatti dell'equipaggiamento) × crescita élite × titolo × Runa della Vitalità",
    ...
    },
    {
      ...
      details: "L'attributo primario è Forza per Melee, Destrezza per Ranged e Intelligenza per Magic."
    },
    {
    ...
    },
    {
      ...
      details: "Gli attacchi fisici usano Difesa; quelli magici usano Difesa magica. Difesa, Difesa magica e Schivata degli eroi hanno un limite dell'80%; Probabilità di critico e Immunità del 100%. L'ignoramento della Difesa viene applicato moltiplicativamente alla riduzione."
    },
    {
      name: "Schivata",
    ...
    {
      name: "Colpo critico",
      formula: "tiro 1–100 ≤ Probabilità di critico effettiva → moltiplica per Danno critico ÷ 100",
      details: "Il Danno critico base degli eroi è 150%. La Probabilità di critico può essere modificata da effetti, passive, titoli, equipaggiamento, Rune, famigli e alcuni segni dei raid."
    },
    {
  ...
  stats: [
    {name:"Forza", kind:"Attributo", text:"Aggiunge 5 PS massimi per punto ed è l'attributo primario di Attacco per gli eroi Melee."},
    {name:"Destrezza", kind:"Attributo", text:"Attributo primario di Attacco per gli eroi Ranged. I combattenti vengono ordinati per Destrezza alla creazione dell'incontro e dopo l'aggiornamento delle statistiche in tempo reale."},
    {name:"Intelligenza", kind:"Attributo", text:"Attributo primario di Attacco per gli eroi Magic; aumenta inoltre il mana ottenuto per azione base con una crescita a radice quadrata."},
    ...
    {name:"Salute", kind:"Difesa", text:"PS massimi. Le barriere assorbono i danni in arrivo prima dei PS, ma non aumentano i PS massimi."},
    {name:"Difesa", kind:"Difesa", text:"Riduzione in punti percentuali contro i danni Melee e Ranged; per gli eroi ha un limite dell'80%."},
    {name:"Difesa magica", kind:"Difesa", text:"Riduzione in punti percentuali contro i danni Magic; per gli eroi ha un limite dell'80%."},
    {name:"Schivata", kind:"Elusione", text:"Probabilità percentuale di evitare un attacco base diretto o un'abilità dannosa; per gli eroi ha un limite dell'80%."},
    {name:"Probabilità di critico", kind:"Offesa", text:"Probabilità percentuale che un colpo usi il Danno critico; ha un limite del 100%."},
    {name:"Danno critico", kind:"Offesa", text:"Moltiplicatore del danno in caso di critico. Un valore visualizzato del 150% corrisponde a danni ×1,5."},
    ...
    {name:"Danno da contrattacco", kind:"Difesa", text:"Percentuale del danno ai PS ricevuto che viene riflessa; la potenza base del contrattacco fisico è 50%."},
    {name:"Rubavita", kind:"Sostentamento", text:"Cura l'attaccante di una percentuale del danno ai PS inflitto."},
    {name:"Rigenerazione", kind:"Sostentamento", text:"Ripristina una quantità fissa di PS durante l'elaborazione del turno dell'entità."},
    {name:"Cura", kind:"Supporto", text:"Percentuale applicata alle cure effettuate e alle autocure pertinenti."},
    {name:"Decadimento", kind:"Effetto", text:"Danno Magic periodico incorporato, inflitto durante l'elaborazione del turno dell'entità colpita."},
    ...
    {name:"Tasso ESP", kind:"Progressione", text:"Moltiplica la quota di ESP dell'eroe prima dei moltiplicatori globali e del dungeon."}
  ],
  ...
  statuses: [
    ...
    {id:"defense_buff", name:"Difesa aumentata", kind:"buff", text:"Aggiunge alla Difesa i punti percentuali mostrati contro i danni Melee e Ranged.", stacking:"Si applica il valore più alto; la durata si rinnova."},
    ...
    {id:"crit_buff", name:"Probabilità di critico aumentata", kind:"buff", text:"Aggiunge alla Probabilità di critico effettiva i punti percentuali mostrati.", stacking:"Si applica il valore più alto; la durata si rinnova."},
    ...
    {id:"hot", name:"Rigenerazione da abilità", kind:"buff", text:"Ripristina i PS mostrati all'inizio di ogni turno; viene applicata dalle abilità attive.", stacking:"Si applica il valore più alto; la durata si rinnova."},
    {id:"healer_hot", name:"Rigenerazione passiva", kind:"buff", text:"Ripristina i PS mostrati all'inizio di ogni turno; viene applicata dalla passiva d'azione di un guaritore.", stacking:"Si applica il valore più alto; la durata si rinnova."},
    ...
    {id:"intercept", name:"Intercetta", kind:"buff", text:"Reindirizza a questa entità gli attacchi nemici diretti agli alleati finché resta attivo.", stacking:"Nessuna intensità visibile."},
    ...
    {id:"vulnerability", name:"Vulnerabilità", kind:"debuff", text:"Aumenta i danni diretti e periodici ricevuti della percentuale mostrata.", stacking:"Si applica il valore più alto; la durata si rinnova."},
    {id:"pattern_vulnerability", name:"Schema osservato", kind:"debuff", text:"Aumenta i danni ricevuti mentre l'Occhio di Veyra osserva tipi distinti di attacco del gruppo.", stacking:"Si applica il valore più alto; la durata si rinnova."},
    {id:"dot", name:"Danno periodico", kind:"debuff", text:"Infligge il danno Magic mostrato all'inizio di ogni turno.", stacking:"Si applica il valore più alto; la durata si rinnova."},
    ...
    {id:"anti_heal", name:"Riduzione cure", kind:"debuff", text:"Riduce tutte le cure ricevute della percentuale mostrata, fino a un massimo del 95%.", stacking:"Si applica il valore più alto; la durata si rinnova."},
    {id:"linked", name:"Legame radicale", kind:"special", text:"Ogni Nodo Radice vivo conferisce a questo nemico +4 Difesa e +1% ai danni. Durante la propria azione recupera il 3% dei PS massimi per nodo, fino al 9%.", stacking:"Persiste per l'incontro."},
  ...
  titles: [
    ...
    {id:"keen_eyed", name:"Occhio di falco", stat:"Probabilità di critico", bonus:10, unit:"punti"},
  ...
  runes: [
    ...
    {id:"precision", name:"Runa della Precisione", stat:"Probabilità di critico", perRank:1, unit:" punto", material:"Verdeggiante → Mareale → Astrale → Eclissi", icon:"res://resources/runes/rune-precision.png", text:"Aggiunge 1 punto percentuale di Probabilità di critico per grado."},
  ...
  ascension: [
    {
      ...
      text:"Colpi decisivi, attacchi critici e finali spietati.",
      skills:[
        {name:"Potere cinereo", tier:0, ranks:5, cost:1, text:"Infliggi +2% di danni per grado."},
        {name:"Impulso del cacciatore", tier:0, ranks:5, cost:1, text:"Ottieni +2% Probabilità di critico per grado."},
        {name:"Radianza seghettata", tier:1, ranks:3, cost:2, text:"I colpi critici infliggono +10% di danni per grado."},
        {name:"Concentrazione spietata", tier:1, ranks:3, cost:2, text:"Infliggi +8% di danni per grado ai nemici con meno di metà Salute."},
        {name:"Corona di ceneri", tier:2, ranks:1, cost:3, text:"Unico: infliggi il 35% di danni in più ai nemici con meno del 20% di Salute."}
      ]
    },
    {
      id:"stone_aegis", name:"L'Egida di Pietra", role:"Tank", color:"#b68b4b", icon:"res://resources/ui/ascension_stone_aegis.png",
      text:"Resistenza, immunità agli impedimenti e un ultimo baluardo contro i danni letali.",
      skills:[
        {name:"Sangue adamantino", tier:0, ranks:5, cost:1, text:"Ottieni +2% ai PS massimi per grado."},
        {name:"Addestramento del bastione", tier:0, ranks:5, cost:1, text:"Ottieni +1 Difesa e Difesa magica per grado."},
        {name:"Presenza imperiosa", tier:1, ranks:3, cost:2, text:"Ottieni +2 Minaccia per grado."},
        {name:"Resistenza sacra", tier:1, ranks:3, cost:2, text:"Ottieni +5% Immunità agli stati per grado."},
        {name:"Ultima cittadella", tier:2, ranks:1, cost:3, text:"Unico: il primo colpo letale di ogni spedizione lascia l'eroe a 1 PS e conferisce una barriera pari al 20% dei PS."}
      ]
    },
    {
      ...
      text:"Potenza delle cure, rigenerazione, protezione delle cure in eccesso e ritmo del mana.",
      skills:[
        {name:"Acque vive", tier:0, ranks:5, cost:1, text:"Aumenta del 3% le cure effettuate per grado."},
        {name:"Mani pazienti", tier:0, ranks:5, cost:1, text:"Ottieni +1 Rigenerazione per grado."},
        {name:"Misericordia traboccante", tier:1, ranks:3, cost:2, text:"Le cure conferiscono una barriera pari al 3% dei PS massimi del bersaglio per grado."},
        {name:"Ritmo luminoso", tier:1, ranks:3, cost:2, text:"Ottieni +5% alla generazione di mana per grado."},
        {name:"Ritornello dell'alba", tier:2, ranks:1, cost:3, text:"Unico: dopo aver usato un'abilità, cura l'alleato più ferito del 12% dei suoi PS massimi."}
      ]
    },
    {
      ...
      text:"Danni ad area, effetti più forti, attivazioni di Vulnerabilità ed echi delle abilità.",
      skills:[
        {name:"Portata della tempesta", tier:0, ranks:5, cost:1, text:"Le abilità che colpiscono tutti i nemici infliggono +3% di danni per grado."},
        {name:"Corrente risonante", tier:0, ranks:5, cost:1, text:"I potenziamenti e le penalità delle abilità sono più efficaci del 2% per grado."},
        {name:"Marchio della burrasca", tier:1, ranks:3, cost:2, text:"I colpi hanno +7% di probabilità per grado di infliggere l'8% di Vulnerabilità per 2 turni."},
        {name:"Tuono incitante", tier:1, ranks:3, cost:2, text:"Usare un'abilità ha +10% di probabilità per grado di conferire a tutti gli alleati +10% ai danni per 2 turni."},
        {name:"Occhio della tempesta", tier:2, ranks:1, cost:3, text:"Unico: le abilità dannose riecheggiano al 40% della potenza contro ogni altro nemico vivo."}
      ]
    }
  ],
  ...
  petEffects: [
    ...
    {id:"max_hp", name:"PS massimi", base:4, unit:"%"},
    {id:"critical_chance", name:"Probabilità di critico", base:1, unit:" punto"},
  ...
  raidMechanics: {
    march_rootbound: {
      ...
      rules:[
        ...
        "Quando agisce un nemico collegato, recupera il 3% dei PS massimi per ogni nodo vivo, fino al 9%.",
        "I Nodi Radice subiscono +25% danni dagli attaccanti Magic o affetti da Decadimento e −20% dalle altre fonti.",
        "Al 70% dei PS, Orrun assorbe i nodi vivi: +5% alla statistica Attacco e +0,1% di rigenerazione dei PS massimi per nodo assorbito. Gli intervalli correnti del danno base e delle abilità non vengono ricalcolati dopo questa modifica all'Attacco. Al 40% compaiono due nuovi nodi.",
        "I due nodi evocati al 40% ripristinano subito ciascuno il 3% dei PS massimi durante le azioni di Orrun. I loro collegamenti a Difesa e danni restano inattivi finché uno dei due non muore.",
    ...
    lightless_armada: {
      ...
      rules:[
        ...
        "A 100 Pressione, ogni eroe vivo subisce danni Magic pari al 10% dei PS massimi e la Pressione torna a 60.",
        "Uccidere un Fuoco Fatuo della Pressione ne rimuove 20; uccidere un Lampionaio Abissale ne rimuove 12.",
        "Il primo critico Ranged di un'azione rimuove 3 Pressione; il primo critico Magic ne rimuove 1.",
        ...
        "Ogni vittoria normale infligge prima danni Magic pari al 4% dei PS massimi e aggiunge 10 Pressione. Dopo le vittorie 5, 10 e 15 la Pressione torna a 20; solo la 5 e la 10 ripristinano anche il 10% di PS e Mana. La comparsa del boss imposta poi la Pressione a 30.",
        "Sotto 30 Pressione, Nhalassa ottiene il 20% di Vulnerabilità per 2 turni. I rinforzi compaiono al 75%, 50% e 25% dei PS del boss; Nhalassa riempie il mana ogni quarta azione del boss."
      ]
    },
    broken_sky_hunt: {
      label:"Quadrante della Costellazione", color:"#8070c5",
      summary:"Fai corrispondere il segno Melee, Ranged o Magic attuale con tre colpi dannosi riusciti prima che trascorrano 10 azioni degli eroi; lo stesso eroe può contribuire in azioni successive.",
      rules:[
        "Il segno inizia da Melee e ruota Melee → Ranged → Magic dopo ogni 10 azioni degli eroi.",
        ...
        "Ogni turno del segno infligge al gruppo danni Magic pari al 4% dei PS massimi, che venga completato o meno. Fallirlo aggiunge una Fame Stellare, fino a cinque.",
        ...
        "Al 20% dei PS, Veyra ottiene +35% ai danni per 6 turni e avvia Divora lo Schema. Completare la costellazione corrente dopo l'inizio di Divora rimuove quel bonus ai danni."
      ]
    },
    last_road: {
      label:"Orologio dell'Eclissi", color:"#c3944d",
      rules:[
        "L'Alba dura 12 azioni degli eroi: Magic infligge +20% e Melee −20% per entrambi gli schieramenti. Ogni cura positiva originata da azione o passiva aggiunge min(3, PS effettivamente ripristinati ÷ PS massimi del bersaglio × 10) Ultimaluce.",
        "Il Crepuscolo dura 12 azioni degli eroi: Melee infligge +20% e Magic −20% per entrambi gli schieramenti. Ogni critico riuscito degli eroi aggiunge 5 Ultimaluce.",
        "L'Eclissi Totale dura 6 azioni degli eroi, moltiplica per 0,65 le cure originate da azioni o passive, inizia infliggendo al gruppo danni Magic pari al 10% dei PS massimi e poi torna all'Alba. Rigenerazione, Rubavita, cure periodiche e autocure dirette ignorano il moltiplicatore di cura della fase.",
        "I danni Ranged sono neutrali durante Alba e Crepuscolo. La durata delle fasi conta le azioni degli eroi, non i round completi o i secondi.",
        "All'80% dei PS del boss compare un Cavaliere Senz'Alba; al 40% compaiono due Motori dell'Eclissi. Gira l'Orologio fa avanzare di 4 il contatore della fase corrente; Furto di Luce di un Serafino dell'Ultimaluce rimuove 15 Ultimaluce.",
        "Al 15% dei PS, 100 Ultimaluce vengono consumate per infliggere ad Aster Null il 35% di Attacco ridotto per 8 turni; altrimenti Aster ottiene +55% ai danni per 8 turni."
      ]
    }
  },
  ...
  probabilityFacts: [
    ...
    {id:"title", name:"Un'offerta della Taverna possiede un titolo", value:"25%", detail:"In caso di successo viene scelto uniformemente uno dei sei titoli: probabilità assoluta del 4,1667% per uno specifico titolo in ciascuna offerta. Salute e Attacco sono ×1,10; Difesa, Difesa magica, Schivata e Probabilità di critico ottengono 10 punti."},
    {id:"egg", name:"Un boss idoneo lascia il proprio uovo di famiglio", value:"15%", detail:"Si applica a ogni uccisione di un boss idoneo di dungeon o raid. Acquistare un uovo di famiglia costa 150 Gemme."},
    {id:"rarity", name:"Rarità alla schiusa del famiglio", value:"74.5 / 20 / 5 / 0.5", detail:"Comune 74,5%, Raro 20%, Epico 5%, Leggendario 0,5%. Ricevono rispettivamente 2, 3, 4 o 5 effetti distinti dall'insieme mescolato della famiglia."},
    ...
    {id:"reward", name:"Ricompensa giornaliera in Gemme", value:"35 Gemme", detail:"Un riscatto per giorno UTC. Con il bonus gratuito di Benvenuto viene assegnata subito; altrimenti il percorso della ricompensa richiede il completamento di una pubblicità con ricompensa, quando disponibile."}
  ],
  ...
  townSystems: [
    ...
    {name:"Famigli", icon:"res://resources/ui/icon_pets.png", lead:"Le uova dei boss si schiudono in famigli da spedizione con livelli Legame permanenti.", facts:["Capienza della scuderia: 60 famigli", "Un famiglio per dungeon o raid permanente; fino a due nella Torre e nella Discesa dell'Eco", "Un famiglio schierato non può essere impiegato altrove", "1 ESP Legame per incontro ordinario e 10 per uccisione di un boss idoneo; le profondità di Torre ed Eco ne conferiscono 25 o 250", "I famigli non schierati possono essere venduti in cambio di Monete", "Livello massimo 20; al livello 20 i valori degli effetti raggiungono ×3 rispetto alla base, mentre il valore di vendita non dipende dal livello"]},
    {name:"Premium e giornaliero", icon:"res://resources/ui/icon_rewarded_ad.png", lead:"Gemme facoltative e un bonus di Benvenuto riscattabile una sola volta.", facts:["Il Pacchetto di Benvenuto è un riscatto GRATUITO una tantum", "Trickster di livello 25 con Ironbark Blade e Ranger Leather", "+10% ESP permanente e moltiplicatore standard dei ritrovamenti", "Il riscatto giornaliero di 35 Gemme diventa immediato", "I pacchetti di Gemme vengono accreditati solo dopo la conferma della piattaforma"]}
  ],

  interactions: [
    {area:"Navigazione principale", actions:["Città apre Taverna, Negozio, Laboratorio, Inventario, Famigli, Posta e riferimenti della città.", "Eroi apre la formazione; seleziona un ritratto o una scheda per statistiche, equipaggiamento, abilità, promozione, Rune, Ascensione, titolo, rinomina o rimozione.", "Dungeon e Raid aprono gli elenchi delle attività; la schermata Raid contiene anche il percorso della Torre e, dopo il Piano 70, la Discesa dell'Eco.", "Selezionare un'attività apre formazione, stato, rapporto, ricompense e combattimento.", "Impostazioni contiene audio, cataloghi di aiuto e riferimento, privacy, Discord, Play Games e cloud ed eliminazione dei dati."]},
    ...
    {area:"Dettagli dell'eroe", actions:["Gli slot di equipaggiamento filtrano gli oggetti compatibili: armi Melee, Ranged o Magic, armature Leggere, Medie o Pesanti e accessori.", "La promozione al livello 25 presenta due schede di specializzazione; quella al livello 50 presenta la classe élite associata.", "Ogni potenziamento di una Runa è garantito quando è disponibile il Frammento corrispondente. I gradi delle Rune non sono casuali.", "Al livello élite 50 scegli un Percorso Ascendente, spendi fino a 15 punti e azzera gratuitamente; cambiare percorso restituisce tutti i punti."]},
  ...
  accuracyNotes: [
    {title:"Versione attuale della guida", text:"Ogni capitolo strategico e calcolatore descrive la versione 1.07 del gioco. La cronologia degli aggiornamenti è limitata alle Note di aggiornamento."},
    {title:"I bonus dei titoli conferiscono 10", text:"Un'offerta generata ha il 25% di probabilità di possedere un titolo. Salute e Attacco usano ×1,10; Difesa, Difesa magica, Schivata e Probabilità di critico aggiungono 10 punti percentuali."},
